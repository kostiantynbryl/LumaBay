...
namespace LumaBay
{
    public static class Localization
    {
        private static readonly Dictionary<string, string> Russian = new Dictionary<string, string>
        {
            ...
            ["restore_need"] = "Недостаточно звёзд",
            ...
            ["tutorial_swipe"] = "Проведите пальцем по соседней фишке, чтобы собрать три одинаковых элемента в ряд.",
            ["tutorial_boosters"] = "Выберите фишку и примените усилитель. Особые фишки активируются во время комбинаций.",
            ...
            ["about"] = "Версия 0.1.2 Alpha • Norvexa Games",
        ...
        private static readonly Dictionary<string, string> English = new Dictionary<string, string>
        {
            ...
            ["tutorial_swipe"] = "Swipe toward a neighboring piece to match three identical items in a row.",
            ["tutorial_boosters"] = "Select a piece and use a booster. Special pieces trigger when included in matches.",
            ...
            ["about"] = "Version 0.1.2 Alpha • Norvexa Games",
